...
static const char *cPer[PORTS_AVAILABLE][PORT_WIDTH][8] = {              // 144 pin
    ...
    },
    {
        ...
        {  "LCD_P1/ADC0_SE9/TSI0_CH6","PTB1","I2C0_SDA","FTM1_CH1", "MII_MDC",        "?","FTM1_QD_PHB","LCD_P1"           },
