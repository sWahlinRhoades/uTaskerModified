/**********************************************************************
   ...
   ---------------------------------------------------------------------
   File:        startup_gnu.s [NXP LPC23XX/LPC24XX]
   Project:     Single Chip Embedded Internet
   ---------------------------------------------------------------------
   Copyright (C) M.J.Butcher Consulting 2004..2013
   *********************************************************************

   08.03.2010 Remove #ifdef for check sum since some GCC versions place the check sum twice - with strange effects {1}
...
irq_handler:
  ...
  ldr r4, =0xFFFFFF00                                                    /* VIC Address Block - LPC23XX/LPC24XX */
