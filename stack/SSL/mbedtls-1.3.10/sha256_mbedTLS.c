...
#if defined CRYPTOGRAPHY && defined CRYPTO_MBEDTLS && defined CRYPTO_SHA // {1}

#define polarssl_zeroize(x,y) uMemset(x, 0, y)                           // {1}
#define memset(x,y,z)         uMemset(x, y, z)
#define memcpy(x,y,z)         uMemcpy(x, y, z)
#define memcmp(x,y,z)         uMemcmp(x, y, z)
#define sha256_starts         mbedtls_sha256_starts                      // for compatibility
