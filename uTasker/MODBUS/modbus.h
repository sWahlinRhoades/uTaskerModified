...
typedef struct stMODBUS_PARS
{
    ...
    unsigned long  SerialMode[MODBUS_SERIAL_INTERFACES];                 // serial settings
    #else
    unsigned short SerialMode[MODBUS_SERIAL_INTERFACES];                 // serial settings
    #endif
...
#define MODBUS_IGNORE_RECEPTION              0xff
