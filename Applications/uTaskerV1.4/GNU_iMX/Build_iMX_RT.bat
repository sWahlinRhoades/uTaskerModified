...
if %iMX_RT%==MIMXRT1010 (uTaskerConvert.exe uTaskerV1.4.bin aes128_coded_XiP.bin E=128-60020200 $%SECRET_KEY% $%VECTOR%) else (uTaskerConvert.exe uTaskerV1.4.bin aes128_coded_XiP.bin E=128B-60020200 $%SECRET_KEY% $%VECTOR%)
uTaskerConvert.exe aes128_coded_XiP.bin Objects/uTaskerV1.4_XiP_%iMX_RT%_otf.bin +boot_header.txt -0x6%MAGIC% -%AUTHENTICATION%
