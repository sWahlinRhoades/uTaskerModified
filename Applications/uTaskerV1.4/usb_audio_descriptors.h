/**********************************************************************
    ...
    *********************************************************************
    06.06.2020 Allow for use by dual-microphone and also on HS USB in parallel to a second device
...
*/
    ...
    #define USB_PRODUCT_RELEASE_NUMBER          0x0100                   // V1.0 (binary coded decimal)
    ...
    #if defined MIC_ONLY && defined MIC_SAMPLING_RATE
        #define SAMPLING_FREQUENCY              MIC_SAMPLING_RATE
    #else
        #define SAMPLING_FREQUENCY              (48000)
    #endif

    #if !defined HS_AUDIO_VERSION
        ...
        #endif
    #endif
    #define USB_PRODUCT_ID_AUDIO                0x0141                   // Freescale reference
    #if defined SPEAKER_ONLY || defined MIC_ONLY
        #define NUMBER_OF_INTERFACES            2
        #define ISOCHRONOUS_ENDPOINT_SIZE       ((SAMPLING_FREQUENCY * 2)/1000) // x2 due to 16 bit data
    #else
        #define NUMBER_OF_INTERFACES            3
        #define ISOCHRONOUS_ENDPOINT_SIZE       96
    #endif
    ...
    #define AUDIO_SOURCE_INTERFACE              2
        ...
        #if defined HS_AUDIO_VERSION
            static const unsigned char HS_usb_language_string[]   = {4,  DESCRIPTOR_TYPE_STRING, LITTLE_SHORT_WORD_BYTES(UNICODE_LANGUAGE_INDEX)}; // this is compulsory first string
            static const unsigned char HS_manufacturer_str[]      = {10, DESCRIPTOR_TYPE_STRING, 'M',0, 'a',0, 'n',0, 'u',0};
            static const unsigned char HS_product_str[]           = {16, DESCRIPTOR_TYPE_STRING, 'F',0, 'A',0, 'S',0, 'T',0, 'm',0, 'i',0, 'c',0};
            #if defined USB_RUN_TIME_DEFINABLE_STRINGS
                static const unsigned char HS_serial_number_str[] = {0}; // the application delivers this string (generated at run time)
            #else
                static const unsigned char HS_serial_number_str[] = {10, DESCRIPTOR_TYPE_STRING, '0',0, '0',0, '0',0, '1',0};
            #endif
            static const unsigned char HS_config_str[]            = {10, DESCRIPTOR_TYPE_STRING, 'C',0, 'o',0, 'n',0, 'f',0};
            static const unsigned char HS_interface_str[]         = {12,  DESCRIPTOR_TYPE_STRING, 'A',0, 'u',0, 'd',0, 'i',0, 'o',0 };

            static const unsigned char *HS_ucStringTable[]        = {HS_usb_language_string, HS_manufacturer_str, HS_product_str, HS_serial_number_str, HS_config_str, HS_interface_str};
        #else
...
typedef struct _PACK stUSB_CONFIGURATION_DESCRIPTOR_COLLECTION_AUDIO
{
    ...
    #if defined SPEAKER_ONLY || defined MIC_ONLY
    USB_AUDIO_CONTROL_INTERFACE_HEADER_DESCRIPTOR_1 audio_control_header1; // audio control interface header descriptor
    ...
    #else
    USB_AUDIO_FEATURE_UNIT_DESCRIPTOR_2        feature_0;                // feature unit descriptor
    #endif
    ...
    USB_ISO_AUDIO_DATA_ENDPOINT_DESCRIPTOR     iso_audio_desc2;          // isochronous audio data endpoint descriptor
        #if defined SPEAKER_ONLY
    USB_AUDIO_CONTROL_ENDPOINT_DESCRIPTOR      endpoint_audio_2;         // third audio endpoint
        #endif
    #else
    ...
    USB_ISO_AUDIO_DATA_ENDPOINT_DESCRIPTOR     iso_audio_desc2;          // isochronous audio data endpoint descriptor
    #endif
} USB_CONFIGURATION_DESCRIPTOR_COLLECTION_AUDIO;
#endif
...
#if defined HS_AUDIO_VERSION
static const USB_DEVICE_DESCRIPTOR HS_device_descriptor =
#else
...
{                                                                        // constant device descriptor
    ...
    {LITTLE_SHORT_WORD_BYTES(USB_PRODUCT_ID_AUDIO)},                     // our product ID
...
#if defined HS_AUDIO_VERSION
static const USB_CONFIGURATION_DESCRIPTOR_COLLECTION_AUDIO HS_config_descriptor =
#else
static const USB_CONFIGURATION_DESCRIPTOR_COLLECTION_AUDIO config_descriptor =
#endif
{
    {                                                                    // config descriptor
    sizeof(USB_CONFIGURATION_DESCRIPTOR),                                // length (0x09)
    DESCRIPTOR_TYPE_CONFIGURATION,                                       // 0x02
    {LITTLE_SHORT_WORD_BYTES(sizeof(USB_CONFIGURATION_DESCRIPTOR_COLLECTION_AUDIO))}, // total length (little-endian)
    NUMBER_OF_INTERFACES,                                                // number of interfaces
    1,                                                                   // configuration value - first
    ...
    sizeof(USB_INTERFACE_DESCRIPTOR),                                    // length (0x09)
    ...
    //
    {
    (sizeof(USB_AUDIO_CONTROL_INTERFACE_HEADER_DESCRIPTOR_1)),           // bLength (0x09)
    ...
    #if defined MIC_ONLY
    {LITTLE_SHORT_WORD_BYTES(39)},                                       // wTotalLength (combined length of this header and all unit and terminal descriptors)
    #else
    {LITTLE_SHORT_WORD_BYTES(40)},                                       // wTotalLength (combined length of this header and all unit and terminal descriptors)
    #endif
    1,                                                                   // bInCollection (number of interfaces in the audio interface collection)
    ...
    1,                                                                   // bTerminalID
    #if defined MIC_ONLY
    {LITTLE_SHORT_WORD_BYTES(USB_AUDIO_INPUT_TERMINAL_MICROPHONE)},      // wTerminalType (microphone - 0x0201)
    #else
    ...
    #if defined SPEAKER_ONLY || (defined MIC_ONLY && defined MIC_STEREO)
    2,                                                                   // bNrChannels
    {LITTLE_SHORT_WORD_BYTES(0x0003)},                                   // wChannelConfig - spacial location of logical channels
    #else
    1,                                                                   // bNrChannels
    ...
    //
    {
    (sizeof(USB_AUDIO_FEATURE_UNIT_DESCRIPTOR_2)),                       // bLength (0x0a)
    CS_INTERFACE,                                                        // bDescriptorType (0x24)
    ...
    1,                                                                   // bControlSize
    {
        (USB_AUDIO_UNIT_CONTROL_MUTE | USB_AUDIO_UNIT_CONTROL_VOLUME),   // bmaControls[0] (0x03)
        0,                                                               // bmaControls[1]
        0
    },                                                                   // bmaControls[2]
    ...
    3,                                                                   // bTerminalID
    #if defined MIC_ONLY
    {LITTLE_SHORT_WORD_BYTES(USB_AUDIO_TERMINAL_STREAMING)},             // wTerminalType (0x0101)
    #else
    ...
    //
    {
    (sizeof(USB_AUDIO_CONTROL_ENDPOINT_DESCRIPTOR)),                     // bLength (0x09)
    DESCRIPTOR_TYPE_ENDPOINT,                                            // bDescriptorType (0x05)
    (IN_ENDPOINT | 1),                                                   // bEndpointAddress
    (ENDPOINT_INTERRUPT),                                                // bmAttributes (0x03)
    {LITTLE_SHORT_WORD_BYTES(8)},                                        // wMaxPacketSize
        #if defined MIC_ONLY
    4,                                                                   // bInterval
        #else
    0,                                                                   // bInterval
    ...
    #if defined MIC_ONLY
    3,                                                                   // bTerminalLink - terminal to which the endpoint of this interface is connected
    #else
    ...
    {LITTLE_SHORT_24BIT_BYTES(SAMPLING_FREQUENCY)}                       // tSamFreq
    },

    // Interrupt OUT audio class endpoint descriptor
    //
    {                                                                    // interrupt in endpoint descriptor for the interface
    sizeof(USB_AUDIO_CONTROL_ENDPOINT_DESCRIPTOR),                       // descriptor size in bytes (0x09)
    DESCRIPTOR_TYPE_ENDPOINT,                                            // endpoint descriptor (0x05)
    #if defined SPEAKER_ONLY
    (OUT_ENDPOINT | 2),                                                  // direction and address of endpoint
    (ENDPOINT_ISOCHRONOUS | ASYNCHRONOUS_SYNCHRONISATION | DATA_ENDPOINT_USE), // endpoint attributes (0x05)
    {LITTLE_SHORT_WORD_BYTES(ISOCHRONOUS_ENDPOINT_SIZE)},                // endpoint FIFO size (little-endian - byte count)
    4,                                                                   // polling interval in ms
    0,                                                                   // refresh
    (IN_ENDPOINT | 2)                                                    // synch endpoint address
    #elif defined MIC_ONLY
    (IN_ENDPOINT | 2),                                                   // direction and address of endpoint
    (ENDPOINT_ISOCHRONOUS),                                              // endpoint attributes (0x01)
    {LITTLE_SHORT_WORD_BYTES((ISOCHRONOUS_ENDPOINT_SIZE) | USB_HS_1_ISO_TRANSACTION)}, // endpoint FIFO size (little-endian - byte count)
        #if defined MIC_STEREO
    USB_HS_2_1ms,                                                        // polling interval in ms (2 transfers each ms)
        #else
    USB_HS_1ms,                                                          // polling interval in ms
        #endif
    0,                                                                   // refresh
    ...
    #if defined SPEAKER_ONLY || defined MIC_ONLY
    0,                                                                   // bmAttributes - no sampling frequency or pitch cntrol
    #else
    ...
    (sizeof(USB_AUDIO_CONTROL_ENDPOINT_DESCRIPTOR)),                     // bLength (0x09)
    DESCRIPTOR_TYPE_ENDPOINT,                                            // bDescriptorType (0x05)
    (IN_ENDPOINT | 2),                                                   // bEndpointAddress
    (EXPLICIT_FEEDBACK_ENDPOINT_USE | ASYNCHRONOUS_SYNCHRONISATION | ENDPOINT_ISOCHRONOUS), // bmAttributes (0x15)
    {LITTLE_SHORT_WORD_BYTES(3)},                                        // wMaxPacketSize
    4,                                                                   // bInterval
    5,                                                                   // bRefresh
    0,                                                                   // bSynchAddress
    },
    #elif defined MIC_ONLY                                               // no content
    #else
