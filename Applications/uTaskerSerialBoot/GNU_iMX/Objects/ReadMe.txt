After the uTaskerSerialBoot project has been successfully built with "fallback=0" in the bat file there will be two files created in this directory:
- uTaskerFallbackLoaderImage_XXXX.bin (where XXXX is the name of the board configured by the bat file parameter set iMX_RT=XXXX).
...
After the uTaskerSerialBoot project has been successfully built with "fallback=1" in the bat file there will be three files created in this directory:
- uTaskerBootComplete_XXXX.bin (where XXXX is the name of the board configured by the bat file parameter set iMX_RT=XXXX).
